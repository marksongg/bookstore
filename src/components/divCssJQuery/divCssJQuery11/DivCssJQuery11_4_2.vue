<template>
  <div id="body1">
    <div id="box">
      <div id="top"><img src="@/assets/images11/114102.jpg" width="800" height="424" alt=""/></div>
      <div id="text">
        <h1>什么是网页设计</h1>
...
<style scoped>
  * {
  ...
  #body1 {
    ...
    font-size: 12px;
    line-height: 20px;
    background-image: url("@/assets/images11/114101.jpg");
  ...
  #text {
    ...
    -webkit-column-gap: 40px; /**列与列之间的间隔 */
    -webkit-column-rule: dashed 1px #000000; /**列与列使用的线 */
  }
